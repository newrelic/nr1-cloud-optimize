...
This project is distributed under the [Apache 2 license](https://github.com/newrelic/nr1-cloud-optimize/blob/main/LICENSE).
...
Contributions are welcome (and if you submit a Enhancement Request, expect to be invited to contribute it yourself :grin:). Please review our [Contributors Guide](https://github.com/newrelic/nr1-cloud-optimize/blob/main/CONTRIBUTING.md).
