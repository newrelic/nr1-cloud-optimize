...
export default function AwsElasticacheRedisNodeViewStandard(props) {
  const { entities, groupName, groupTitle } = props;
    ...
    <>
      <Card collapsible style={{ marginLeft: '0px' }}>
        <CardHeader
          ...
          title={
            groupTitle || `AWS ELASTICACHE REDIS NODE (${entities.length})`
          }
          additionalInfoLink={{
            label: `Pricing`,
