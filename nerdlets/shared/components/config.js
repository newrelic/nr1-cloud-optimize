        ...
        <Modal.Content className="config config-dark">
          <Form inverted={false}>
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.lastReportPeriod}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.discountMultiplier}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.staleInstanceCpu}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.staleInstanceMem}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.staleTransmitBytesPerSecond}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.staleReceiveBytesPerSecond}
                onChange={(e, data) => {
                  this.handleConfigurator(
                    e,
                    data,
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.rightSizeCpu}
                onChange={(e, data) => {
            ...
            <Form.Field inline>
              ...
              <Input
                inverted={false}
                value={this.props.config.rightSizeMem}
                onChange={(e, data) => {
